...
I used Python (ML, quick write ups) and TypeScript (full-stack web services w/ TanStack Start), I would like to learn Rust. I do not want to write comments in code as code should explain itself.